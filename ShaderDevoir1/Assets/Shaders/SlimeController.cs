...
public class SlimeController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // --- CHOIX DU MODE DE WOBBLE ---
        if (useDynamicWobble)
        {
            // Mode 1 : Dynamique (Attaque / Relâchement)
            if (_isRising)
            {
        ...
        {
            // Mode 2 : Statique (lié directement à la variable publique)
    ...
    {
        // Sécurité : Si un autre script déclenche un choc, on réactive le mode dynamique automatiquement
